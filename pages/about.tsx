  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div>
          <a>
            <h2>Warp is an &ldquo;ephemeral token&rdquo;, which can be moved to a new token iteration once per month. </h2>
            ...
            <p>A special contract, titled &ldquo;click_to_start_mayhem&rdquo;has been created, anyone who knows the compiled bytecode for the initial warp token (warp0) can deploy the token and special helper contract.</p>
